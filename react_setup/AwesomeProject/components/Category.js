    ...
    render(){
      ...
      if(this.state.fontsLoaded){
        return (
            ...
            <Image
                style={ (windowHeight * 0.15) < (windowWidth * 0.28) ? categoryStyles.categoryImageHeight : categoryStyles.categoryImageWidth}
                source = {cameraIcon}
            />
            <Text style={ (windowHeight * 0.15) < (windowWidth * 0.28) ? categoryStyles.categoryNameHeight : categoryStyles.categoryNameWidth}>Umetnost</Text>
            </TouchableOpacity>
        );
      }else{

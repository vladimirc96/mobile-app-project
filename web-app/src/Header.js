...
import black_log_in_icon from "./assets/images/black_login.png"
...
render() {
    return (
        ...
        <a className="navbar-brand" href="#"><img src={logo_naziv} width="310" height="50"/></a>
        ...
        <div className="collapse navbar-collapse" id="navbarsExampleDefault">
            ...
            <form className="col-sm-6 col-lg-3">
                <div class="search_main">
                    <button class="submit_bt"><a href="#"><span class="doctor"><img src={white_log_in_icon} width="25" height="25"/></span>Uloguj se</a></button>
                </div>
            </form>
        </div>
        </nav>

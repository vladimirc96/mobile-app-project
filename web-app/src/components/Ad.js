			...
			<div className="row ad-container" style={{ justifyContent: "space-between" }}>
				...
				<div className="ad-description-container">
					...
					<div className="row ad-description-text">
						<p className="text">
							Lorem ipsum dolor sit amet consectetur adipiscing elit.Pellentesque sapien lacus,interdum
							vitae massa nec,laoreet tempus tellus. Proin aliquet nibh quam, ac efficitur felis maximus
							ac. Phasellus pellentesque urna et ante commodo, gravida luctus eros viverra. Nullam mollis
							erat diam. Fusce venenatis gravida mi ac condimentum. Nulla eu pulvinar neque. Proin rutrum
							dui sed ligula congue, id facilisis odio blandit. Cras non metus posuere, mattis justo sit
							amet, ornare orci.
						</p>
					</div>
					<div className="row">
